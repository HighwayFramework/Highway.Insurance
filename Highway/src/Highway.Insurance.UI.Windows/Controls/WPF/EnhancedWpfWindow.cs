...
namespace Highway.Insurance.UI.Windows.Controls.WPF
{
    ...
    /// </summary>
    public class EnhancedWpfWindow : EnhancedWpfControl<WpfWindow>
    {
        public EnhancedWpfWindow() : base() { }

        public EnhancedWpfWindow(string searchParameters) : base(searchParameters) 
        {
