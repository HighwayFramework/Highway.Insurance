...
namespace Highway.Insurance.UI.Windows.Controls.WinForms
{
    ...
    /// </summary>
    public class EnhancedWinWindow : EnhancedWinControl<WinWindow>
    {
        public EnhancedWinWindow() : base() { }
        
        public EnhancedWinWindow(string searchParameters) : base(searchParameters) 
        {
